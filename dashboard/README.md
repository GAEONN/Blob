...
Keep this folder beside the existing Blob modules; this is a companion, not a standalone
package or a modification to SmallBlob.

The overview shows Music, System, Sound and Gaming at once. Click **Game dock** to detach
the narrow overlay to the left. It starts click-through: **Ctrl+Alt+D** unlocks it. Click
...
Settings only affects Dashboard. Audio playback/volume/boost control Windows' shared
media and audio services. Avoid enabling multiple enhancers at the same time.
