...
hit testing in the fused neck: click restores the full card, while click-drag repositions the bubble.
The main lobe never becomes a drag target. A short gesture explanation belongs in Music settings so
